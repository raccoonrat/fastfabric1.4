...
import (
	...
	"github.com/fabric_extension/persistence/ledger/kvledger/txmgmt/txmgr/lockbasedtxmgr"
	"github.com/fabric_extension/persistence/ledger/ledgerstorage"
...
func (l *kvLedger) CommitWithPvtDataByNo(seqNum uint64) error {
	panic("implement me")
}
