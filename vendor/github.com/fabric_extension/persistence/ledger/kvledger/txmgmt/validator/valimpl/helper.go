...
func preprocessProtoBlock(txmgr txmgr.TxMgr, validateKVFunc func(key string, value []byte) error,
	...
	for txIndex, envBytes := range block.Data.Data {
		...
		if txType == common.HeaderType_ENDORSER_TRANSACTION {
			...
			respPayload, _ := utils.GetActionFromEnvelope(envBytes)
		...
		if txRWSet != nil {
			b.Txs = append(b.Txs, &valinternal.Transaction{IndexInBlock: txIndex, ID: chdr.TxId, RWSet: txRWSet, ValidationCode:txsFilter.Flag(txIndex)})
		}
	}
	return b, nil
}
