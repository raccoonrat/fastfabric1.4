...
import (
	"github.com/fabric_extension/persistence/ledger/util"
...
func deserializeBlock(serializedBlockBytes []byte) (*common.Block, error) {
	block := &common.Block{}
	var err error
	b := util.NewBuffer(serializedBlockBytes)
...
func extractHeader(buf *util.Buffer) (*common.BlockHeader, error) {
...
func extractData(buf *util.Buffer) (*common.BlockData, []*txindexInfo, error) {
...
func extractMetadata(buf *util.Buffer) (*common.BlockMetadata, error) {
	metadata := &common.BlockMetadata{}
	var numItems uint64
