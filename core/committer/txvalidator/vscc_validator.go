...
func (v *VsccValidatorImpl) VSCCValidateTxByNo(tIdx int, blockNo uint64) (error, peer.TxValidationCode) {
	...
	if alwaysEnforceOriginalNamespace {
		...
		if respPayload.Events != nil {
			...
			if ccEvent, err = action.GetEvent(); err != nil {
